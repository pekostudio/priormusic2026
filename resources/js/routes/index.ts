...
/**
* @see \App\Http\Controllers\FavoriteController::favorites
...
/**
* @see \App\Http\Controllers\TrackController::tracks
* @see app/Http/Controllers/TrackController.php:16
* @route '/tracks'
*/
export const tracks = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tracks.url(options),
    method: 'get',
})
...
* @route '/tracks'
*/
tracks.url = (options?: RouteQueryOptions) => {
    return tracks.definition.url + queryParams(options)
}
...
* @route '/tracks'
*/
tracks.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tracks.url(options),
    method: 'get',
})
...
* @route '/tracks'
*/
tracks.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: tracks.url(options),
    method: 'head',
})
...
* @route '/tracks'
*/
const tracksForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tracks.url(options),
    method: 'get',
})
...
* @route '/tracks'
*/
tracksForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tracks.url(options),
    method: 'get',
})
...
* @route '/tracks'
*/
tracksForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tracks.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
